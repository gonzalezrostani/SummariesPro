...
# ---- UI ----
st.markdown(
    "<p style='font-size:12px;'>Feel free to use our AI tool. Just paste your text to get an initial summary — no prompt needed. You may request up to three revisions.</p>",
